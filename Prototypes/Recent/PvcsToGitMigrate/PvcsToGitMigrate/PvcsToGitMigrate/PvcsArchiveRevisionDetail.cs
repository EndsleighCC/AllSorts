...
namespace PvcsChangeControl
{
    public class PvcsArchiveRevisionDetail
    {
        ...
        {
            return String.Format("{0}{1} {2} {3} {4:6} \"{5}\"", ConsoleDisplay.Indent(indent), RevisionNumber, PromotionGroup, DeveloperId, (String.IsNullOrEmpty(IssueNumber) ? "\"\"" : IssueNumber), Description);
        }
