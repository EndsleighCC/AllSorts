...
{
    ECServiceDetails ServiceDetails ;
...
bool ECServicesSet::ProcessIsAService( const char * pcszProcessName )
{
    ...
    ECServiceDetails ServiceDetailsThis ;
...
int main( const int cintArgCount , const char * apcszArgValue[] )
{
    ...
    DWORD cbProcessIdSize = sizeof( adwProcessId ) ;
    ...
    else
    {
        ...
        dwProcessIdCount = cbProcessIdSize/sizeof( adwProcessId[0] ) ;
                    ...
                    else
                    {
                        ...
                        else
                        {
                               ...
                               )
                            {
                                ...
                                if ( ServicesSet.ProcessIsAService( szEXELongName ) )
                                    cout << "Service " ;
                                else
                                    cout << "Process " ;
                                   ...
                                   )
                                {
                                    ...
                                    else if ( ServicesSet.ProcessIsAService( szEXELongName ) )
                                    {
